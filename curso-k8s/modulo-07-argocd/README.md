...
vêm do repositório git. Introduzido no ArgoCD 2.6, **estável no v3.x atual**:
...
> **Nota v3**: no ArgoCD v3 o campo `source` (singular) foi depreciado em favor
> de `sources` (plural), mesmo para aplicações com fonte única.
